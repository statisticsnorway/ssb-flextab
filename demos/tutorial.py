...
# Bext, we use a measure column instead. For measure columns we have several different statistics to choose from. Her is an example.
...
# We can format the numbers in the table cells by adding formats within the table argumanet. First American with thousands separator.
